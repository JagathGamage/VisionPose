...
# Change to the "content" directory inside the new current directory
os.chdir('content')
...
# Uncomment below if you want to see the current directory
# print(os.getcwd())
...
output_dir = os.environ.get("OUTPUT_DIR", "output")  # Fallback to "output" if env variable is not set
