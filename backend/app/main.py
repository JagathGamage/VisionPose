...
# We also serve video files statically from the frontend/public/videos folder:
STATIC_FILES_DIR = os.path.join(HOME, "frontend", "frontend", "public", "videos")
...
async def process_and_dump():
    # Stub—your own pose‐estimation logic goes here.
    print("processAndDump called")
